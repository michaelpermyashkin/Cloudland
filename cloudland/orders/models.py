...
class Order(models.Model):
    ...
    shipping_address = models.ForeignKey(UserAddress, on_delete=models.CASCADE, blank=True, null=True)
    billing_address = models.ForeignKey(UserBillingAddress, on_delete=models.CASCADE, blank=True, null=True)
